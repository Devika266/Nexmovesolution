...
$route['services/(:any)'] = 'welcome/service/$1';
...
$route['admin/editing/(:any)'] = 'admin/editing/$1';
...
$route['blogdetails/(:any)'] = 'welcome/blogdetail/$1';
$route['portfoliomain'] = 'welcome/portfoliomain';
$route['website/portfoliomain'] = 'welcome/portfoliomain';
